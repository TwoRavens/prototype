...
class MongoClientUtil(object):
    ...
    def get_collection(self, database_name: str, collection_name: str, should_prefix=True) -> Collection:
    ...
    def current_op(self, database_name: str, user: str):
        ...
        print(f"Current Mongo operations for {user}: ",
              json.dumps(current_ops, default=lambda o: f"<<non-serializable: {type(o).__qualname__}>>"))
