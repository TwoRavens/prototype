...
import ModalVanilla from "../components/views/ModalVanilla";
import ButtonPlain from "../components/views/ButtonPlain";
...
export default class ModalWorkspace {
    ...
    view(vnode) {
        ...
        return m(ModalVanilla, {id: 'workspaceModal', setDisplay},
            ...
            process.env.CLIENTSIDE_DOMAIN === "core" && m(Table, {data: (workspace.datasetDoc || {}).about}),
