...
import ListTags from "../components/views/ListTags";
import Button from "../components/views/Button";
import Icon from "../components/views/Icon";
import TextFieldSuggestion from "../components/views/TextFieldSuggestion";
import * as model from "../../tworavens/workspace/model/index";
import {setSelectedPebble, toggleGroup, toggleTag} from "../../tworavens/workspace/model/index";
...
export default class ForceDiagramGroup {
    view(vnode) {
        ...
        return m('div.card', {
            style: {margin: '.5em', padding: '1em', width: 'calc(100% - 1em)', background: utils.hexToRgba(group.color, group.opacity)},
        }, [
            m(TextField, {
                autocomplete: "off",
    ...
    view(vnode) {
        ...
        return m('div.card', {
            style: {
                ...
                padding: '1em',
                width: 'calc(100% - 1em)',
                border: `4px solid ${utils.hexToRgba(label.color, label.opacity)}`
            },
        }, [
            m(TextField, {
                autocomplete: "off",
