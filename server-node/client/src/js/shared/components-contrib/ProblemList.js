...
export class ProblemList {
    view(vnode) {
        ...
        let discoveryAllCheck = m(Checkbox, {
            ...
            onclick: tworavens.setCheckedDiscoveryProblem,
            ...
            m('div#discoveryTablesContainer', {
                ...
                [
                    m('h4.card-header.clearfix',
                        ...
                        selectedProblem.pending && m(Button, {
                            ...
                            onclick: () => {
                                ...
                                workspace.ravenConfig.problems[problemCopy.problemId] = problemCopy;
                        ...
                        selectedProblem.manipulations.length !== 0 && m(Button, {
                            ...
                            class: 'btn-sm',
                            disabled: tworavens.rightTab === 'Manipulate' && common.panelOpen['right'],
                    ...
                    m(Table, {
                        ...
                        activeRow: workspace.ravenConfig.selectedProblem,
                        // showUID: false,
                        abbreviation: 40
                    })
                ],
                    ...
                    m(Table, {
                        ...
                        onclick: problemId => {
                            ...
                            if (clickedProblem.system === 'solved') {
                                ...
                                tworavens.setSelectedMode('results');
                                return;
                            }
