...
export let debug = process.env.CLIENTSIDE_PRODUCTION === "true"
    ? Object.keys(console).reduce((out, key) => Object.assign(out, {key: _ => _}), {})
    : console;
...
export let abbreviate = (text, length) => text.length > length
    ...
    : text;
export let warn = (text, style) => m('', {
        style: Object.assign({color: '#dc3545', display: 'inline-block'}, style ?? {})
    },
    text);
