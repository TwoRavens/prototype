...
import {TreeAggregate, TreeAugment, TreeImputation, TreeSubset, TreeTransform} from '../components-contrib/QueryTrees';
...
import Flowchart from '../components-contrib/Flowchart';
...
import {formatVariableSummary} from '../components-contrib/VariableSummary';
        ...
        constraintMenu && [
            m(Button, {
                ...
                style: {
                    ...
                    bottom: `calc(${common.heightFooter} + ${common.panelMargin} + 6px + ${tworavens.peekInlineShown && tworavens.peekData ? tworavens.peekInlineHeight : '0px'})`,
                    position: 'fixed',
                    'z-index': 101,
                ...
                onclick: () => {
                    ...
                    tworavens.updateLeftPanelWidth();
...
function canvas(compoundPipeline) {
    ...
    let {pipeline, variables} = queryMongo.buildPipeline(compoundPipeline, tworavens.workspace.ravenConfig.variablesInitial);
...
export function leftpanel() {
    if (!tworavens.workspace.name || !constraintMenu)
        return;
    ...
    return m(Panel, {
            ...
            attrsAll: {
                ...
                style: {
                    ...
                    height: `calc(100% - ${common.heightHeader} - 2*${common.panelMargin} - ${tworavens.peekInlineShown && tworavens.peekData ? tworavens.peekInlineHeight : '0px'} - ${common.heightFooter})`
                }
            }
        },
        varList()
...
export function varList() {
    ...
    let variables = tworavens.workspace.ravenConfig.variablesInitial;
        ...
        m(PanelList, {
            ...
            colors: Object.assign(
                selectedProblem.groups.reduce((out, group) =>
                    Object.assign(out, {[utils.hexToRgba(group.color, .2)]: group.nodes}), {}),
                {
                    [utils.hexToRgba(common.colors.selVar, .5)]: selectedVariables,
                    [utils.hexToRgba(tworavens.colors.order, .2)]: selectedProblem.tags.ordering,
                    [utils.hexToRgba(tworavens.colors.location, .2)]: selectedProblem.tags.location
                }),
            classes: {
                ...
                'item-time': Object.keys(tworavens.variableSummaries)
            ...
            popup: x => m('div',
                ...
                m(Table, {
                    ...
                    class: 'table-sm',
                    data: formatVariableSummary(tworavens.variableSummaries[x])
                })),
    ...
    editable && [
        m(Button, {
            ...
            onclick: () => {
                ...
                tworavens.setLeftTab('Variables');
...
export let setConstraintMenu = async menu => {
    ...
    let variables = [...queryMongo.buildPipeline(
        ...
        tworavens.workspace.ravenConfig.variablesInitial)['variables']];
